...
void SetNextRobotStateInAutomaticMode() {
    ...
    if (robotState.distanceTelemetreDroit > 30 &&
            ...
            robotState.distanceTelemetreExtremeGauche < 20) //Obstacle à extreme gauche
        positionObstacle = OBSTACLE_A_EXTREME_GAUCHE;
    else if (robotState.distanceTelemetreDroit < 30 &&
            robotState.distanceTelemetreExtremeDroit < 20 &&
            robotState.distanceTelemetreCentre > 20 &&
            robotState.distanceTelemetreGauche > 30 &&
            robotState.distanceTelemetreExtremeGauche > 30) //Obstacle à extreme droit
        ...
        positionObstacle = OBSTACLE_A_DROITE;
            ...
            robotState.distanceTelemetreCentre > 20 &&
            robotState.distanceTelemetreGauche < 30 &&
            robotState.distanceTelemetreExtremeGauche < 30) //Obstacle àgauche
        ...
        positionObstacle = PAS_D_OBSTACLE;
            ...
            robotState.distanceTelemetreCentre > 20 &&
            robotState.distanceTelemetreGauche < 30 &&
            robotState.distanceTelemetreExtremeGauche < 30) //Obstacle à extreme gauche
        positionObstacle = OBSTACLE_A_EXTREME_GAUCHE;
    else if (robotState.distanceTelemetreDroit > 30 &&
            robotState.distanceTelemetreExtremeDroit > 30 &&
            robotState.distanceTelemetreCentre > 20 &&
            robotState.distanceTelemetreGauche < 30 &&
            robotState.distanceTelemetreExtremeGauche < 20) //Obstacle à extreme droit
        positionObstacle = OBSTACLE_A_EXTREME_DROIT;
